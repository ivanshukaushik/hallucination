...
- **ivanshukaushik** — Lead researcher, empirical work, data pipeline, Python implementation
- Theoretical grounding and code architecture developed in collaboration with Claude (Anthropic)
